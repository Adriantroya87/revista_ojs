<?php return array (
  ...
  'manager.setup.competingInterestsDescription' => '
pedirá a los revisores/as que cumplan con la política de divulgación "
conflictos de intereses que especifique a continuación."',
  'manager.setup.reviewOptions.remindForInvite' => '
un recordatorio si el revisor/a no responde a una solicitud de "
(días):"',
  'manager.setup.reviewOptions.remindForSubmit' => '
un recordatorio si el revisor/a no entrega una recomendación (días):"',
  'manager.setup.homeHeaderImageInvalid' => '
de la imagen del logotipo de cabecera de la página inicial "
o error de subida. Formatos aceptados: .gif, .jpg y .png."',
  ...
  'manager.paymentMethod.currency.description' => '
pagos realizados directamente desde este sitio web se realizarán en "
moneda seleccionada."',
  'manager.setup.additionalContentDescription' => '
elemento introducido aquí aparecerá en su página de inicio."',
  'manager.setup.authorCopyrightNotice' => 'Aviso de derechos de autor',
  'manager.setup.authorCopyrightNoticeAgree' => '
necesario que los autores acepten el aviso de derechos de autor como "
del proceso de envío."',
  'manager.setup.homepageImageDescription' => '
una imagen para visualizarla en primer plano en la página de inicio."',
  'manager.setup.pageFooterDescription' => '
cualquier imagen, texto o código HTML que quiera que aparezca "
la parte inferior de su sitio web."',
...
disponible un mapa del sitio en XML para enviarlo a los motores de "
en <a href="{$path}" target="_blank">{$path}</a>"',
  'stats.articlesOfTotal' => '{$count} de {$total} artículos',
  'stats.dateRange.instruction' => '
una fecha en formato YYYY-MM-DD . Por ejemplo, si quiere ingresar "
fecha para el 15 de enero de 2019, ingrese 2019-01-15."',
